...
def autoGear(rpm):
    ...
    #                               MTB TRAIL
    #            30x10  30x12  30x14  30x16  30x18  30x21  30x24  30x28  30x33  30x39  30x45  30x51
    #gearbox = [  3.00,  2.50,  2.14,  1.88,  1.67,  1.43,  1.25,  1.07,  0.91,  0.77,  0.67,  0.59]    
    
    #                               MTB XC
    #            42x11  42x13  42x15  32x13  32x15  32x17  32x19  32x21  32x24  24x19  24x21  24x24  24x28  24x32  24x36
    #gearbox = [  3.83,  3.23,  2.80,  2.46,  2.13,  1.88,  1.68,  1.52,  1.33,  1.26,  1.14,  1.00,  0.86,  0.75,  0.67]
